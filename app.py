...
def main():
    ...
    user_input = st.text_input("a beutiful lady who stand in the park")

    image_input = st.text_input("a beutiful lady with dress in the spring time catch a camera by her hand and other hand put it in her mouth while she is smiling")
